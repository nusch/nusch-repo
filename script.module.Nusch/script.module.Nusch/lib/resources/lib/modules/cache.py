...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'Nusch Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.Nusch')
    ...
    try:
        curVersion = control.addon('script.module.Nusch').getAddonInfo('version')
