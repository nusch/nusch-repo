...
class movies:
    def __init__(self):
        ...
        self.theaters_link = 'http://www.imdb.com/search/title?title_type=feature&num_votes=1000,&release_date=date[365],date[0]&sort=release_date_us,asc&count=40&start=1'
