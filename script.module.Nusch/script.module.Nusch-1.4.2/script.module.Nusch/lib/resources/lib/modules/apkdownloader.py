...
import xbmc, xbmcgui, urllib, sys, time, xbmcaddon, os
...
def _pbhook(numblocks, blocksize, filesize, dp, start_time):
	try: 
		...
		LogNotify("ERROR Downloading: %s" % str(e), xbmc.LOGERROR)
		pass
	if dp.iscanceled(): 
		dp.close()
		LogNotify("[COLOR %s]%s[/COLOR]" % (COLOR1, ADDONTITLE), "[COLOR %s]Download Cancelled[/COLOR]" % COLOR2)
		sys.exit()