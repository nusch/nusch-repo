...
elif action == 'apkinstall':
    from resources.lib.modules import apkinstall
    apkinstall.apkInstaller()
...
elif action == 'libsetup':
    from resources.lib.modules import libcreate
    libcreate.lib_setup()